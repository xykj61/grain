...
Hosted `mala_delivery.rye` unchanged. Extend `tools/murr_m2_witness.rish` with the device lab (parity count stays **201** unless a separate stanza is preferred — keep count unchanged).
