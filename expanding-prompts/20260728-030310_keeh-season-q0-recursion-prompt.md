...
```
[ [ Quin — counsel session, the Keeh Season (sixteen rounds lean q0–q15; expand 32),
...
CORE SCOPE (paused — do not advance g-rounds while quint walks):
...
QUINT SCOPE (this season — walk here):
...
waymark: <q-round reached — or "q0 complete, q1 next">
...
*Paste the block above to open q0. Keep all five scope pauses honest every round.*
