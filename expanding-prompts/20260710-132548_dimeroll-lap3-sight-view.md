# Expanding Prompt — Dimeroll Lap 3 Sight View
...
1. Extend `booksviewtest` — P&L + BS lines (10 total)  
2. Add `sightviewtest` — carriage + books unified frame  
3. `tools/dimeroll_sight_view.rish` + updated `dimeroll_books_view.rish`  
4. Parity **210**
