...
> *In section"Why Close Is Greener and Faster," find:* "It leans on common materials drawn from nearby supply chains rather than scarce ones carried from troubled places."
...
> *In section"The Real Constraint," find:* "A community that issues its own currency is held back less by accounting than by what is real"
...
>
> *In section"Funded Openly," find:* "A modest public investment -- modest beside the budgets nations already keep -- can fund"
...
> *In section"Where It Sits Among the Rest," near* "Realidream is an open browser as much as an editor," *add a clause:* "-- a bounded, honest surface over its own graph and the open web it chooses to render, rather than a from-scratch engine rivaling the few the world maintains."
