...
Radiant pass `20260728.060038` — u55 guests → `guest_murr_*` · elves `murr-*.elf`
...
|-----|-------------|--------|
| Mint issuer→holder | **15569** | `guest_murr_mint_tx` / `guest_murr_mint_rx` |
| Receipt holder→issuer | **15570** | `guest_murr_receipt_tx` / `guest_murr_receipt_rx` |
