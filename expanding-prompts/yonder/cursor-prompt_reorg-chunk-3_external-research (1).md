...
- `996_TAME_STYLE.md` — `**Status:** Living`, the coding-style canon for Rye. **Recommended: promote to `context/TAME_STYLE.md`** (living, no stamp), beside `RADIANT_STYLE.md` and `TIGER_STYLE.md`. It is the active style guide, not a dated relic. *(See the erratum at the top — this was corrected to de-number in place instead.)*
