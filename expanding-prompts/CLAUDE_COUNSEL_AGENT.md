...
**Companion:** `20260802-161500_ashvini-recursive-prompt-v2.md` (the baton this agent prints each round) - `../context/RIYO.md` (the voice) - `../foundations/20260826-024942_the-grain-and-the-crossing.md` (the crossing law)
