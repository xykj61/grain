...
**Stamp:** `20260728.025220` · Radiant pass `20260728.180806`  
...
INNERMOST SCOPE (this season — walk here):
  ...
  u0–u90 COMPLETE · check-in · fascia 86 · shred RED · ungated prune empty · u91 next.
...
run gen_murr (GREEN; deploy RED) · report · then walk u91 from the charter:
...
waymark: u90 complete, u91 next
nib <origin/main short nib>
bench report (verbatim, if any): <REPORT/STOP — or "none">
scope: outer=paused(m8/m9) inner=paused(i6/i7) innermost=open(u91)
