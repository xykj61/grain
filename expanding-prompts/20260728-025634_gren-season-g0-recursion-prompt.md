...
**Stamp:** `20260728.025634` · Radiant pass `20260728.040656`  
**Use:** paste the fenced block as the next counsel/bench session opener.  
Radiant pass `20260728.040656` — g4 first spot-check empty · g5 next  
...
CORE SCOPE (this season — walk here):
  ...
  g0–g4 COMPLETE · g5 next (spot-check empty×1 · overwrite CLEARED).
  Bare ads CLEARED g1; Inner+printouts g2; Constellation prep+index g3; spot empty g4.
...
then walk g5 from the charter:
  affirm three pauses above + quint CLOSED · affirm Djin→Gren · DJINN→Murr · Keaton→Gren ·
  second spot-check: no living bookmark sells gen_djin / djin.fund as present ·
...
scope: outer=paused(m8/m9) inner=paused(i6/i7) innermost=paused(u0)
  core=open(g5) quint=closed(handed_back) geode=prep(d0)
