...
**Stamp:** `20260728.025634` · Radiant pass `20260728.040802`  
**Use:** paste the fenced block as the next counsel/bench session opener.  
Radiant pass `20260728.040802` — g5 second spot-check empty · g6 next  
...
CORE SCOPE (this season — walk here):
  ...
  g0–g5 COMPLETE · g6 next (spot-check empty×2 · overwrite CLEARED).
  Bare ads CLEARED g1; Inner+printouts g2; Constellation prep+index g3; spot empty g4–g5.
...
then walk g6 from the charter:
  affirm three pauses above + quint CLOSED · affirm Djin→Gren · DJINN→Murr · Keaton→Gren ·
  third spot-check: no living bookmark sells gen_djin / djin.fund as present ·
...
scope: outer=paused(m8/m9) inner=paused(i6/i7) innermost=paused(u0)
  core=open(g6) quint=closed(handed_back) geode=prep(d0)
