...
You can watch this hold for yourself. The module builds and proves green while touching nothing real -- `rye` is at `rye/bin/rye` in your clone rather than on your PATH, and the toolchain variable is how every build in this tree points at the pinned Zig (corrected `20260821.190707`, REDS %118: this page previously wrote a bare `rye`, which no reader could run):
