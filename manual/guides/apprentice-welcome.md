...
Create a [GitHub](https://github.com) account (ideally the same username you want everywhere). Then ask Cursor to help you get set up with the instructions in the Grain root [`SOURCE.md`](../../SOURCE.md). Clone from **`https://github.com/xykj61/grain.git`**. Codeberg is retired from this pier’s living push for now.
...
If you cannot afford Cursor’s paid plan that includes Agent mode (about twenty dollars a month at the time I write this), reach out to me and let’s talk. The same invitation stands if Claude’s paid plan is out of reach right now.
