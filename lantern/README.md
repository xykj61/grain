...
| **1** | `max_tokens` truncate - length stop - zero budget refused | `tools/l/lantern_lap1.rish` |
| **2** | Model allow-list gate - unknown hash refused | parity **252** - `tools/l/lantern_lap2.rish` |
| **3** | `temperature` + `seed` - range and pin checks | parity **258** - `tools/l/lantern_lap3.rish` |
| **4** | `top_p` - range and pin checks | parity **275** - `tools/l/lantern_lap4.rish` |
| **5** | `err_stop` - fixture pin | parity **279** - `tools/l/lantern_lap5.rish` |
| **6** | `stop_sequence` - response fixture pin | parity **283** - `tools/l/lantern_lap6.rish` |
| **7** | `stop_sequence` - request pin + mismatch refuse | parity **287** - `tools/l/lantern_lap7.rish` (`191112`) |
| **8** | `prompt` - request pin + mismatch refuse | parity **294** - `tools/l/lantern_lap8.rish` (`192749`) |
| **9** | `max_tokens` - request pin + mismatch refuse | parity **298** - `tools/l/lantern_lap9.rish` (`193358`) |
| **10** | `text_pin` - response pin + mismatch refuse | parity **302** - `tools/l/lantern_lap10.rish` (`200203`) |
| **11** | `temperature` - request pin + `TemperatureMismatch` | parity **306** - `tools/l/lantern_lap11.rish` (`200819`) |
| **12** | `seed` - request pin fixture + mismatch refuse | parity **310** - `tools/l/lantern_lap12.rish` (`211930`) |
| **13** | `top_p` - `TopPMismatch` distinct from `BadTopP` | parity **314** - `tools/l/lantern_lap13.rish` (`211930`) |
| **14** | `err_stop` - request pin + `ErrStopMismatch` | parity **318** - `tools/l/lantern_lap14.rish` (`212715`) |
| **15** | `length_stop` - request pin + `LengthStopMismatch` | parity **322** - `tools/l/lantern_lap15.rish` (`212715`) |
| **16** | Empty allow-list - `EmptyAllowList` | parity **326** - `tools/l/lantern_lap16.rish` (`213317`) |
| **17** | `allow_count` - pin + `AllowCountMismatch` | parity **330** - `tools/l/lantern_lap17.rish` (`213317`) |
| **18** | Dual-model allow - assist hash welcome | parity **334** - `tools/l/lantern_lap18.rish` (`213738`) |
| **19** | `require_model` - pin + `RequireModelMissing` | parity **338** - `tools/l/lantern_lap19.rish` (`213738`) |
| **20** | `stopped_reason` - eos pin | parity **342** - `tools/l/lantern_lap20.rish` (`214145`) |
| **21** | `stopped_reason` - length pin | parity **346** - `tools/l/lantern_lap21.rish` (`214145`) |
| **22** | `stream` - pin false | parity **350** - `tools/l/lantern_lap22.rish` (`215613`) |
| **23** | `stream` - pin true | parity **354** - `tools/l/lantern_lap23.rish` (`215613`) |
| **24** | `stopped_reason` - err_stop pin | parity **358** - `tools/l/lantern_lap24.rish` (`223639`) |
| **25** | `stopped_reason` - stop_sequence pin | parity **362** - `tools/l/lantern_lap25.rish` (`223639`) |
| **26** | `top_k` - request pin | parity **366** - `tools/l/lantern_lap26.rish` (`224322`) |
| **27** | `frequency_penalty` - request pin | parity **370** - `tools/l/lantern_lap27.rish` (`224322`) |
| **28** | `presence_penalty` - request pin | parity **374** - `tools/l/lantern_lap28.rish` (`224805`) |
| **29** | `n` - request pin | parity **378** - `tools/l/lantern_lap29.rish` (`224805`) |
