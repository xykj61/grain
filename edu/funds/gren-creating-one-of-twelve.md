...
Radiant pass `20260728.015541` — Twah → Gren overwrite · Inner Scope seated
...
| **3** | Know the tropical seat (Gren = Taurus · index 1) | **taught · witnessed m6** |
...
**arc: Gren m5–m8 CLOSED** at the refuse-walk (was Djin · was Twah).
...
| Check | Result |
|-------|--------|
| Anchor form | `gren.fund` — name + `.fund` |
| Claim | **Keaton's hand alone** |
| Tutorial duty | Teach the rule; never run the registrar |
| Elder sibling note | Siya's elder anchor path remains separate; Gren does not inherit another fund's domain |

**witness:step2** `.fund` anchor + claim-his — GREEN when gen-gren passes.

---

## Step 3 — tropical seat

Each fund seats one tropical sign. Index runs **0..11** (Aries through Pisces). Gren is **Taurus**, fund-order **2**, sign-index **1**.

| Field | Gren |
|-------|------|
| Sign | Taurus · earth |
| Fund order | 2 (after Murr · before Siya) |
| Sign index | **1** |
| Vane lean | `%gren` |
