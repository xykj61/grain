# The saga of the Commence Arc — trust the tree, test the instrument
...
| Surface | Standing |
|---------|----------|
| Tree | Living pins · waymarks · almanac seats name what metal already said |
| Instrument | Planted controls before totals · green and red both proven |
| Faults | Counsel-lane tool faults caught by controls — not blamed on the tree |
| What this is not | Invented episodes · shred by silence · totals before control |

## 3. Arc witness pane

| Movement | What it proved |
|----------|----------------|
| **M1** | In-container census · baton museum · glow desk · tip/parent basis corrected |
| **M2** | Glow rune census · advisory 11/11 still drift · hygiene GREEN |
| **M3** | Oldness census — GREEN cloud-lane · awaits home land |
| **M4** | Radiant pass — GREEN cloud-lane · awaits home land |
| **M4b** | Census control — planted positive + planted negative · seat 99 |
...
| Surface | Standing |
|---------|----------|
| Planted control | Proven green · prove-red refuses · must be tracked to fire |
| Shed census | Orphan floor **852** · session-logs **690** · health **41 → 51** if shed |
...
| Meter | Standing |
|-------|----------|
| sundial | **100 · green** (pinned) |
| fascia (elder pin) | **86** (pinned) |
| fascia_health | **41** fresh shed · **51** if orphans shed |
| orphans | **852** basename floor · errs toward keeping |
| advisory-11 | **11/11** still drift (pinned) |
| shred | **RED** |
| baton museum | 13 halls · breach **0** |
