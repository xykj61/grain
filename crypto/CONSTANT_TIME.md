...
**Front door:** [`README.md`](README.md) · **Clean-room law:** [`../.claude/rules/gratitude-licenses.md`](../.claude/rules/gratitude-licenses.md)
...
| `hmac_sha512.rye` | the HMAC key | data-independent — the key enters only as block-XOR and hash input | key XOR is unconditional |
