...
## The twenty-seven files — twenty-four primitives and three compositions
...
twenty-seven per-file witnesses in the dependency order above, rebuilding and reproving
