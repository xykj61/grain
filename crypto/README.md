...
## The twenty-eight files — twenty-five primitives and three compositions
...
twenty-eight per-file witnesses in the dependency order above, rebuilding and reproving
