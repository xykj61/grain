...
**Lane (b), archiving stale witnesses, waits for S0's table.** The criteria you named are right — superseded, retired surface, duplicate GREEN — and applying them before the cost table exists would be cutting in the dark. After S0, each candidate cut is its own small lap with its evidence in the commit body.
