...
**Closed:** `20260821.174047` - **Last dated file:** `20260805.000001` - **Folded to** `date/YYYYMMDD/` on `20260821.171105`
...
**Mined on touch, never wholesale.** When living work cites a piece here, lift that piece's live insight into the room it belongs in *then*. Reading 764 files to extract insight is a project measured in weeks with an unknowable yield -- it would stall, and a half-converted room is worse than either end.
