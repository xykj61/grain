# MUR Season — Round u6 · Tool · Module Wave Map

**Stamp:** `20260728.044738`  
**Season:** [`20260728-025220_the-mur-season-innermost-charter.md`](20260728-025220_the-mur-season-innermost-charter.md)  
**Prior:** [`20260728-044443_mur-season-u5-gratitude-residual.md`](20260728-044443_mur-season-u5-gratitude-residual.md)  
**Voice:** Quin · nested frame Trey · Trya  
**Ground:** origin/main `db7afefdb0` (pre-send)  
...
| Path | Change |
|------|--------|
| `expanding-prompts/README.md` | Index blurbs MALA → MUR (was); dated paths kept |
| `expanding-prompts/…_glow-application-framework…` | Payments / TUBE4 / Lexicon cite → MUR (was MALA) |

## Wave map (charter blocks · inventory)

### Lexicon · prose — **u6–u31** (walking)

Living counsel / edu / expanding-prompts / foundations Radiant-pass.  
**u6** seats this map and continues light prose. Dated filenames may keep `mala` stamps; living ads must not.

### Tool · generator — **u32–u47**
...
**Discipline:** one witness GREEN per rename wave; no silent tree-wide sed.

### Module · mycelium · specs — **u48–u79**
...
| Block | Rounds | Hold |
|-------|--------|------|
| MUR↔WOV unify design | u80–u95 | concepts only |
| WOV retirement plan | u96–u111 | **roadmap last** |
...
*Camera: the map is drawn before the forge moves. Prose lamps already say MUR; the rye shelves still carry mala labels until the tool and module waves open.*

He does not rename the shelf tonight. He names which shelf moves when, and clears one more corridor of living ads.

*Cut. u6 complete. u7 next.*

---

*May the wave map keep overwrite honest, may tools and modules wait their rounds, may living prose keep teaching MUR.*
