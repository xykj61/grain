...
| Step | Standing |
|------|----------|
| Lexicon **Twah (fund)** · Taurus · `%twah` · twah.fund | seated |
| Fund-order **2** · sign-index **1** (Taurus) | affirmed |
| Domain **twah.fund** claim | **his hand** · not run this round |
| Edu page one stub | **landed** · outline only |
| Constellation `add_seat` for Twah | waits on his wallet/gas · package unaudited |
| Sovereign lane via Comlink | door measured present · no seating bytes sent |

## Twah's gift

The edu-series tutorial for creating one of the twelve (four-letter name · `.fund` domain · tropical seat) remains Twah's gift, now under the fund seat. Page one names the shape and hard lines; fuller walk is m6–m8.

## Stack step proven

`prin rish generator → Comlink` — present and gated. Amphora · Glow · Aurora already closed under Mala; Twah's early rounds stay earth-and-teaching paced rather than re-walking every house door.

## Trey — documentary frame

*Camera: a second generator beside the first, chalk still dusted from Mala.*

He does not buy twah.fund. He writes a door that would rather quit than claim a domain. The earth seat's first gift is a page that teaches how twelve names join a wheel — four letters, a DNS anchor, no mint, no wallet from a tutorial. Somewhere a registrar waits; tonight the repository practices the lesson without the purchase.
