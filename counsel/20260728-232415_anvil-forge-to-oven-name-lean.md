...
| **Tandoor** / **Chulha** | Deep · specific · hold unless you want that cultural seat |

## Breach shape (when seated)

Separate from dated-writing Class H mutants. MUR-shaped: **content breach** then **filename/path breach** on his word · gratitude pin for [debrided] affirmed · living mutant of `lantern-lattice-anvil` → new stamp with new title · Class H the old path · `anvil/` module rename is the heavy door (parity · Skate views · Q-vane faculty) — size before cutting.

## What this paper does *not* do

No rename · no `git mv` · no living prose rewrite · no shred.
...
*Proposed `20260728.232415` · Quin · bread over blades*
