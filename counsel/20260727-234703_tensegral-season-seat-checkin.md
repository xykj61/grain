# Check-in — Sound seated · Tensegral Season open
...
| Lean | Door |
|------|------|
| **A · Prep kg** | Expanded prompt(s) · Prim names · one **Pond run** · then round 0 bow |
| **B · Bow now** | Skip remaining prep; open round 0 measure on next kg |
| **C · Revise charter** | Rename arcs, reorder themes, or retarget prep before any kg |
| **D · Claude eyes** | Outside read of season charter + Lexicon seats before prep |

## Recommended lean

**A · Prep kg** — the charter already says prep before bow; Expanded · Prim · Rish · Realidream · Pond run are seated so the first greens can name themselves.

---

*May tension hold and compression stay discontinuous, and may your next word open the prep or the bow.*
