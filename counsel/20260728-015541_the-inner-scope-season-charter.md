...
Radiant pass `20260728.025220` — inner stays PAUSED i6/i7 · innermost MUR Season opens (u0–u127) · Mala/MALA→Murr/MUR approved
...
## Checkpoint — outer pauses

**Outer scope** = the Constellation Season (m0–m31 lean). It **pauses** at the finishing edge:

| Outer standing | Value |
|----------------|-------|
...
| Close | **i15** | Summary · resin-or-handoff lean · **second warn** on extend vs return · handoff |

Rounds **i14** and **i15** are the extend-or-return gates. Counsel reports state and names the choice; timing stays Keaton's.

## Scope vocabulary (seated)

| Word | Meaning here |
|------|----------------|
| **scope** | Named bound of work — a season, a Tally garden, a Prin view, or a rish command's reach |
| **outer** | The paused (or resumed) enclosing season — here, Constellation m-rounds |
| **inner** | The nested season running inside a pause — here, i0–i15 |

Prin / Tally / rish may speak these words (`prin scope`, and later Tally marks) without inventing a third nesting layer beyond outer/inner unless he seats one.

## Fascia relation

Fascia f0–f1 already walked; f2–f15 and the resin spine remain charted in [`20260728-011055_the-fascia-season-charter.md`](20260728-011055_the-fascia-season-charter.md). This inner season **is** the fold word for Fascia work into a nested runway: Constellation holds the outer bookmark; fascia redaction shredding walks inside.

## Trey — documentary frame

*Camera: two clocks on one desk — outer hands stopped at eight, inner hands starting at zero.*

He does not shred the constellation by renaming a bull. He pauses the wheel, whispers a four-letter name drawn from poets who knew the unseen company, and opens a smaller season inside the pause — sixteen breaths to teach the tree how to forget with proof. The earth seat keeps its sign. Only the word changes. Rumi, Hafez, Kabir, Ibn Arabi — thanked by name; their verse stays outside the tree.

*Cut. Outer waits. Inner begins.*
