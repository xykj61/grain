...
**Language:** EN  
**Last updated:** `20260802.010651` (Equinox e193 — Tally Glow Tend limb 3)  
**Status:** Living — room open; first residents + Tally Tend limbs 1–3 seated
...
Further candidates: Caravan/Aurora pedestals — each arriving as Glow Tend beside its Rye elder.
