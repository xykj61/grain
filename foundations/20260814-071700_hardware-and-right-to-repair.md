...
Front door: [`../mikrophone/README.md`](../mikrophone/README.md). One-command proof: [`../tools/d/drey_witness.rish`](../tools/d/drey_witness.rish) runs all thirteen rungs from cold and asserts each GREEN.
