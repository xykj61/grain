...
| `20260825.211055` | [Mycelium -- the Consensus Protocol](20260825-211055_mycelium-the-consensus-protocol.md) | the tree's own leaderless consensus season gathered into one map -- 98 modules from the Cord to the Testament, TigerBeetle + Mysticeti thanked clean-room, the order decided once and read by all the same; 80 witnesses on metal, every real-world crossing a held gate |
