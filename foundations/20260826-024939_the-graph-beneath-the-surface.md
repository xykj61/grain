...
- **In build** -- the surface this graph feeds (Skate - Realidream) is the [WADE plan](../expanding-prompts/20260825-233311_wade-bit-design-system-and-dimeroll-entities.md)'s domain.
