...
Carry little. Encrypt what you carry under keys held elsewhere. Delete by destroying the key. Prefer *nothing to give* over any clever switch.

This brief is a **standing gate**: every feature that touches a person's device or data states how it minimizes, where keys live, and how deletion stays ordinary under a published retention and legal-hold regime.

## Three techniques

**Minimize first.** Data never collected cannot be seized, subpoenaed, breached, or misused. Every feature names, before it stores, the least it must remember for its one purpose. Collection is the exception that justifies itself.
...
One test sorts configuration:

> *If I change this, could it weaken who may see my data, or how long it is kept?*
