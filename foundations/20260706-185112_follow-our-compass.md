...
*May the compass always point home to strands we already trust. May the grain keep its name where it names structure, and the compass keep ours where we need direction.*
