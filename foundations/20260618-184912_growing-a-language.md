...
> **On the council rota, Water/Venus dual `20260821.211423`** -- graduated to `foundations/` because it is worth reading with the code deleted (`.claude/rules/design-rooms.md`), having been re-seated from `yonder/` to `active-designing/` on `20260817.200443` when the rota first reached it; relevance and inbound citation outrank the stamp (`../ORGANIZING.md`). Early brief written `20260702.185912`, consumed into the living records; that stamp endures as the moment it was written. Index: `README.md`.
