...
**Ground:** [`context/specs/20260701-221512_cellar-functional-spec.md`](../../context/specs/20260701-221512_cellar-functional-spec.md)
...
| **(e) Witness** | `tools/cellar_first_ring.rish` → parity **+1** |

## Custody rulings already recorded (do not reopen)
...
1. **Module home** — `cellar/` vs nested under an existing module (recommendation with one sentence why)
...
4. **Witness contract lines** — what `cellar_first_ring.rish` asserts (welcome and one unwelcome path if cheap)
...
No `cellar/` implementation, no parity wire, no functional spec status change beyond what Kaeden affirms.
