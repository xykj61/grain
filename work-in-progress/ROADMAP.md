...
**STOA157 hexa-shape alias GREEN, `20260721.004052`** — lean A (alias path): closed allowlist `hexa-shape` ≡ `hexa-mold` (six-field `$:` / HexaMold); `is_hexa_named_mold` accepts the alias; bartis · barket desks; capacity freeze held. Brief [`active-designing/20260721-004052_stoa157-hexa-shape-alias.md`](../active-designing/20260721-004052_stoa157-hexa-shape-alias.md). Next: **STOA158** check-in (hepta-shape · rename · Sala behind shape).
