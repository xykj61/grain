...
**STOA131 pair-mold flip call-body GREEN, `20260720.193357`** — lean A (compass): closed multi-field `$:` `%-  flip` · PairMold swap · baked 5/3 → 3/5; double under pair and flip under `@u32` refuse; argv · gold · Sala B0 held. Brief [`active-designing/20260720-193357_stoa131-pair-call-body.md`](../active-designing/20260720-193357_stoa131-pair-call-body.md). Next language: **STOA132** map (gold · argv under tagged/pair · triple-mold · Sala B0 still held).
