...
**STOA130 stated · nesting · gold vocabulary GREEN, `20260720.192738`** — lean A (compass): seat Glow nest ladder stated · nesting · gold; rename living APIs `assert_sample_not_nesting` · `assert_sample_nesting_nests` · `is_nesting`; LEXICON merge; dated wet/dry briefs kept; ambient gold held. Brief [`active-designing/20260720-192738_stoa130-stated-nesting-gold.md`](../active-designing/20260720-192738_stoa130-stated-nesting-gold.md). Next language: **STOA131** map (gold · call-body under pair · Sala B0 still held).
