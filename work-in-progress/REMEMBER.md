...
**Last refreshed:** `20260730.032348` (EDT) · voice Riyo  
...
**Git nib:** `37eb8eb66b` · Grain · table.rye GREEN · red 31 · ls-remote guard · dual remotes  
...
**Season:** Framework · EDT · **Grain** · **finishing edge:** **undeca** *(canon)* — Voice **OPEN** · 256 season · equinox **A** · journey **2** (h2 Aparigraha) · quest **Do** · round **6/256** · **table.rye** landed / **gossip.rye** next · name **parked** · Equinox **PAUSED** e6/e7 · Surface **PAUSED** · GitHub dual (`origin` · `xykj61`) · narrow-scope (fascia 71) · Riyo stands · Prefer **git nib**. · `prin scope`  
...
| Door | Kind |
|------|------|
| **Voice Season Build Journey** | **OPEN** · A·J2·Do · descriptor+table GREEN · next `gossip.rye` (single-file) · handoff expanding-prompts/20260730-030553_bench-handoff-256-open.md |
| **Baton museum** | **SEATED** `context/baton-museum/` · Lexicon baton · census zero · breach banked |
| **Dual remotes** | **SEATED** origin + xykj61 · ls-remote guard on send · main tips agree `8b22e7acd0` · red 31 closed |
