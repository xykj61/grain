...
**Git nib:** `572c0877fb` · Grain · cloud pier
...
| **Next-season breach** — Pond + loadable skies · Bron→Kyri molt · Kyri the voice — now **unblocked**: JARL's settlement doors all stand (opens on Keaton's word) | next season · charter seated |
