...
**Git nib:** `6a845f516b` · Grain · cloud pier
...
**Next-season breach — seat-approved `20260810`** (charter: `expanding-prompts/20260810-000032_the-next-season-breach-charter.md`): (1) Pond + skies; (2) **Bron → Kyri** by **molt** (2,163 `.bron` kept whole as fossils, new logs born `.kyri`, 378 refs forward — never a rewrite); (3) **Kyri the standing voice**, superseding Quin + the OS variants (Reya·Riyo·Trey·Triz·Trya); (4) `kyri.sol`/`kyri.sui` reference — **Keaton's hand alone**, no wallet/key here. **Kyri** added to favorites (`comlink-tendency`). Open: does Kyri name the voice, the notation, or both. All opens **after JARL**. Baton: [`../expanding-prompts/20260809-021406_the-compass-season-baton-four-equinoxes.md`](../expanding-prompts/20260809-021406_the-compass-season-baton-four-equinoxes.md).
