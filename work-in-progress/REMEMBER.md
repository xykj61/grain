...
**Season:** Framework · EDT · **Grain** · **finishing edge:** **undeca** *(canon)* — Voice **OPEN** · 256 season · equinox **A** · journey **2** (h2 Aparigraha) · quest **Do** · round **6/256** · Check shapes pre-written · **table** Check → **gossip** → **introduce** · name **parked** · Equinox **PAUSED** e6/e7 · Surface **PAUSED** · GitHub dual · narrow-scope (fascia 71) · Riyo stands · Prefer **git nib**. · `prin scope`  
...
| Door | Kind |
|------|------|
| **Voice Season Build Journey** | **OPEN** · A·J2·Do · table Check → gossip → introduce · single-file · handoff expanding-prompts/20260730-030553_bench-handoff-256-open.md |
