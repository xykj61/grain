...
- [x] **Four OS-variant names confirmed** `20260714` — Reya (`002123`), then Riyo/Trey/Triz + the two-pair symmetry (`035600`, "approve to gates ... to all"). Riyo/Reya and Trey/Triz are the two diverse-redundant pairs. **Still open (build-time, not a name):** the *shape* of the redundancy — two codebases from one spec, or one codebase with two independently-verified paths.
- [x] **Ojjo O-vane name confirmed** `20260714.034900`; build timing (now-as-horizon vs defer) still open.
- [x] **Pool P-vane confirmed** `20260714.042545` — Gall-expanded applications vane, headlined as a content-creation computational data market; **zero collision in the Urbit kernel** (whole `old/` searched), nothing to rename; secularizes the Linengrow foundations to Acme-generic; composes MALA/Neth/Granary/Mandi/Open Asks/Comlink/Sigma/Kumara. Design [`../external-research/20260714-035600_pool-p-vane-content-data-market.md`](../external-research/20260714-035600_pool-p-vane-content-data-market.md). **Build questions open:** whole-vane-vs-market-specialized; seat-now-vs-defer.
- [x] **Quin Q-vane proposed** `20260714.042545` — inference vane unifying the four voices (**Lantern · Lattice · Anvil · Scribble**) under TAME + Maze guidance; the fifth thing the four make; **kernel-quiet** (only "quintillion"/"quindecillion" in number-to-words.hoon, incidental). Design [`../external-research/20260714-042545_quin-q-vane-inference-voices.md`](../external-research/20260714-042545_quin-q-vane-inference-voices.md). **Awaiting confirm.**
- [ ] **Nested deterministic-testing sandboxes — compose, don't name a new vane** (recommendation `20260714.042545`): agents spawn agents in ephemeral test regions where seeded deterministic testing rides inside the prompting (Glow vibe-coding automation). Honest home is a composition each vane already owns — **Quin** (agents) × **Puddle** (ephemeral isolation, Pond bounds inside) × **Neth** (seeded deterministic replay), Maze-sheltered, TAME-guided. If a single named pattern is wanted, it lives in the Maze nursery, not as a new vane. Awaiting Keaton's word on home.
