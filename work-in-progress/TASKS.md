...
**Finishing edge:** the breach is **OPEN** — JARL's settlement doors all stand (six witnesses GREEN), and **Move 1 (Pond)** has begun: Pond is seated as Grain's **application module**, and Pool has retired into it by molt (living `foundations/20260810-011514_pond-the-application-module.md`; the Pool study bannered as a readable fossil). The remaining breach moves — the loadable **skies** that finish move 1, the **Bron→Kyri** molt, **Kyri the voice**, and the `kyri.sol`/`kyri.sui` reference (Keaton's hand) — follow as their own rounds. How the breach relates to the Compass Season's remaining equinoxes (BUHR · TACT) is Keaton's to shape.
...
| Breach — remaining: loadable **skies** (finish move 1) · **Bron→Kyri** molt · **Kyri** the voice · `kyri.sol`/`kyri.sui` (Keaton's hand) | breach | charter-ready · own rounds |
