...
**The per-file sweep is now a standing check, not a one-time read:** [`../../tools/s/sel4_userlevel_license_witness.rish`](../../tools/s/sel4_userlevel_license_witness.rish) over [`../../tools/fixtures/v/vendored_license_scan.sh`](../../tools/fixtures/v/vendored_license_scan.sh), GREEN on metal with both RED legs proven.
