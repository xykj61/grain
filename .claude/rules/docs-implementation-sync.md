...
- **Update the doc that describes it in the same commit as the code change**, not as a later follow-up. Accrete-never-break applies by **tier** (TAME section 4): living docs and code are Tier 3; testimony takes a recorded pass or erratum; proof-sealed bytes never move.
