...
- **The finishing edge still holds.** Lindy-first keeps the finishing edge in force rather than licensing many durable starts at once; ship one real thing before naming the next (`../counsel/date/20260715/20260715-190000_the-design-over-build-ratio-and-finishing.md`). Crux-first picks *which* one.
