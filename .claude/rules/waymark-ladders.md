...
| **DAHL** | `harvest-season-equinox-3-commons` | Harvest Chapter Equinox 3 -- Commons (Skate social layer - community) |
| **KOFF** | `harvest-season-equinox-4-rest` | Harvest Chapter Equinox 4 -- Rest (consolidation - saga close - 3/4 reading) |
| **CION** | `meta-season-chronological-labeling-molt` | CION Meta-Chapter -- molt-debride-sweep count-up IDs -> chronological/semantic labels (after Compass) |
...
| **LOCA** | `macos-native-surface-rye-backend` | **The macOS native surface** -- a Rye/AppKit backend beside Brushstroke's Wayland one: the checked Objective-C seam, a real view class, input into Skate's event ring, parity with Wayland, and the iOS door. Drawn `20260828.222500` after two probes proved the platform reachable from Rye alone, zero Swift linked |
