...
The whole of Capricorn lives where these roots cross. Positive, the sign is tenacious and clear-eyed at once: it endures, it sees truly, and it uses that sight to fix what is broken, finding the fault precisely so it can mend it. Negative, the same pairing hardens into a force that is unyielding, narrow, and quick to condemn. The difference between the two is not a different sign; it is the same instrument played well or poorly, tuned by the welcome the sign receives in the chart.

## Reading it in a chart

In a reading, name tenacity and realism plainly as the sign's foundation, then walk the six traits as a spectrum, letting the sign's dignity tell you how far toward the bright face or the shadowed one this particular Capricorn leans. Speak to the endurance and the objectivity as real assets, and offer the shadows gently, since each is only a strength turned too far. Read this way, Capricorn stops being a compliment or an accusation and becomes a true, workable picture of a person built to last and to see clearly.
