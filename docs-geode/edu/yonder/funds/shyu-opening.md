...
Shyu recommends **used** hatchbacks and SUVs (Hyundai when they fit) via Craigslist and Facebook Marketplace:
...
- dedication (Wayne) and sponsor (Hyundai) stay distinct hats  

witness:shyu-open GREEN — seat · Wayne dedication · Hyundai sponsor · used-mobility lean · hard lines
