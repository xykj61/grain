...
is a promise about your next twenty minutes rather than a note about house style. The elder
first-hour page in [`../../manual/`](../../manual/README.md) told readers for months that the
tools *"came with the copy"* while a fresh clone builds both from source (REDS %117), and checking that
