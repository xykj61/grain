...
**Sangha** is the assembly of peers — and this is its pattern book: the ways peer-to-peer communication composes from the house's own pieces. **Comlink** carries sealed facts between peers. **Weave** is the append-only spine they agree on. **Mantra** projects a history anyone can replay. **Amphora** carries a record across a crossing. **Mand** holds authority and audit. **Murr** moves value. **Pond** gives it all a surface. A pattern is a *proven composition* of these — never a proposal wearing a pattern's clothes.
