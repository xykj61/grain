...
`rishi/bin/rishi run tools/readme_metrics.rish write` to refresh them;
[`tools/readme_metrics_witness.rish`](tools/readme_metrics_witness.rish) compares the block
...
| Reading | Now |
|---|---|
| **Fascia** -- can a reader follow any thread home | **40** / 100 |
| **Witnesses** running on metal | **1658** |
