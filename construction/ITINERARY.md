...
**Git nib:** `6c39d41875` (**From the front door, every living door opens.** The 112 living broken links go to **zero** -- 97 by suffix-unique repoint, 205 index rows given their day prefix, 87 delinked because the log never landed in any commit, 15 by hand -- and `readme_reach` seats as the **34th guard**, gating living at zero and ratcheting testimony at 1,108 over 1,418 documents reached 15 deep. `autoproject96` becomes **`groupproject405`**; the deep debride is **booked as a standfast**, since only 11 of 199 occurrences sit in commit messages and GitHub keeps a redirect. The **astrology method ships** while `readings/` and `yonder/` stay withheld. `context/KYRI.md` molts into **Gauge** in place under a checkpoint, with no fossil, because a living path carrying 153 references molts in place.)
