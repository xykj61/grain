...
### `20260819.125806` -- ITINERARY's Season-G scene-read chronicle folded to a pointer as the live edge moves to the Microkernel Target
...
**Swept:** `construction/ITINERARY.md` (471 -> ~75 lines), `THREADS.md`, `TASKS.md`, `ROADMAP.md` -- all rewritten from the elder Equinox-season e-number ladder to the four-equinox Compass Season.
