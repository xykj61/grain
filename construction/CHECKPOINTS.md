...
**Checkpoint `20260913.203000` -- walk-back nib `6ae1c2049`.** *Swept:* rows `20260912.172929` and `20260913.200226` leave the living pin together for `construction/archive/REDS-two-readers-that-needed-a-verdict-rows-727-728.md`. Both rows are CLOSED, and the new row puts the pin 163 bytes over its 40,960-byte bound. *Why:* both faults let a missing reading masquerade as evidence: one treated an absent search command as an empty population, and one treated an unfinished transcript as a receipt. The shelf preserves both rows whole; the pin keeps every OPEN row.
