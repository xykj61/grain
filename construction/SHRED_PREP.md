...
*Four seated molts -- Pool to Pond, Riyo to Kyri, the root `.brix` descriptor, and the old-waymark shed -- folded whole to [`archive/SHRED_PREP-four-seated-molts-20260810-20260818.md`](archive/SHRED_PREP-four-seated-molts-20260810-20260818.md) on `20260826.010645`, each closed and awaiting no decision. Moved as two Class M rows carried this pin to 25,594 bytes against the 24,576 it declares.*
