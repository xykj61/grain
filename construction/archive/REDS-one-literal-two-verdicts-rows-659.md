...
**Row:** `%659` (`20260909.001908`) -- BOOKED, born onto this shelf. The spine answered `next_free=655`
...
**Recovery:** The parked row is rebound to `%659` against the fetched shared spine. Its immutable stamp remains `20260909.001908`; the former shelf path routes here so dated logs keep their references.
