# Itinerary -- landed laps, shelved `20260825.003210`

*Shelved from the living card [`../ITINERARY.md`](../ITINERARY.md) as row %215 and the Region
reading carried it past its 24,576-byte bound. Four rounds of `20260824`, oldest first. Each names
where its numbers live; walk back with `git log --oneline` and the session log of the same stamp.
