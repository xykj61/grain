# ITINERARY -- landed accounts, shelved `20260909.001908`

**Language:** EN
**Status:** Archive -- the PHEROMONE account the live card carried before this stamp
**Voice:** Kyri

Shelved whole so the live front holds one account per ship. Accrete-never-break: nothing here is edited.

---

**PHEROMONE -- A CORRECTION CAUGHT ONE-FOR-THREE AND THEN MADE THE SAME ERROR AT TWO.**
Elder [shelved](20260908-234354_itinerary-landed-accounts.md).
