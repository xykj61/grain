# ITINERARY -- landed accounts, folded `20260905.235749`

*Folded whole from the living [`../ITINERARY.md`](../ITINERARY.md) live front, to bring the card
back under the byte bound its own header declares after two ships landed into it in one hour. Both
accounts below had already CLOSED, and both already had their ledger rows on their own shelves --
`%430` at [`REDS-a-floor-that-voted-rows-430.md`](REDS-a-floor-that-voted-rows-430.md) and `%438`
at [`REDS-a-repair-that-raised-a-meter-rows-438.md`](REDS-a-repair-that-raised-a-meter-rows-438.md)
-- so what moved here is the card's own one-paragraph account of each, not the record. The card
keeps what is OPEN and what waits on Keaton's word. Walk-back and reasoning:
