# ITINERARY landed accounts -- shelved `20260906.040933`

**Language:** EN
**Status:** Shelf -- immutable once written
**Voice:** Kyri
**Where this came from:** [`../ITINERARY.md`](../ITINERARY.md), whose live front holds what is OPEN.

The card stood at 40,779 of its 40,960 ceiling with 181 bytes free when `%459` landed. This account
is CLOSED and stands whole in [`../REDS.md`](../REDS.md); only the card's retelling moved here, by
the card's own rule that a finished section folds to a shelf rather than earning a raise.
