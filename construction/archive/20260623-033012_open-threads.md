...
- **Strengthening stdlib doc + width pass (`031812`).** All 82 `external-research/yonder/strengthening-compiler/` passes enriched with `## Rye std surface` signatures and `## Width notes`; crosswalk `20260621-032327_strengthening-width-crosswalk.md`; enricher `tools/enrich_strengthening_docs.rye`; prompt `10025`. Named `mem` snapshot bounds → `u32`.
