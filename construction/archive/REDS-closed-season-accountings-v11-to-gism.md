# REDS -- the closed season accountings, v11 through GISM-J6r1

**Language:** EN
**Style:** Gauge -- Meter setting (see [`../../context/GAUGE_STYLE.md`](../../context/GAUGE_STYLE.md))
**Voice:** Kyri
**Status:** Archive -- five reds-first allocation accountings, every one closed, every byte kept
...
*Each block records what a season's reds-first allocation did: how many reds the arc found, what
closed them, and whether the remaining journey allocation was released or booked. They span
`20260808.183836` to `20260812.185056` and every one is settled, so they rest here rather than in
the living pin -- the same closed-range fold this ledger has taken sixteen times.*
