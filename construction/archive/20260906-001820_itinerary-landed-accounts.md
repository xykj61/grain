# ITINERARY -- landed accounts, folded from the living card

**Folded:** `20260906.001820` -- **Status:** Archived, complete, never edited
**Living card:** [`../ITINERARY.md`](../ITINERARY.md) -- **Checkpoint:** [`../CHECKPOINTS.md`](../CHECKPOINTS.md)

*Three CLOSED accounts from `20260905`, moved here whole when the card stood 453 bytes under its
own 32,768 bound with two reds waiting to be booked. Each paragraph's detail also stands in its
REDS row and in the session log that recorded it; this shelf keeps the card's own words.*
...
**Petrichor's mark-law weave LANDED** (`20260905.224930`) -- and the weave had nowhere to land:
