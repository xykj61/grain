...
- **`baton-museum/`** -- eleven halls of baton shapes (counsel close - agent cover - recursion prompt - tiered handoff - cursor relay - infusion - bench apply report - waymark - handback - season summary - queue packet). Seated `20260730.030553`.
