...
| **Quin** | Proposed (`20260714.042545`) — inference **Q-vane**, the unifying host of the four voices (**Lantern · Lattice · Anvil · Scribble**) under TAME + Maze guidance; the fifth thing the four make; kernel-quiet; sandbox-testing loop = Quin (agents) × Puddle (ephemeral isolation) × Neth (seeded deterministic replay), composed not newly-named — [`../external-research/20260714-042545_quin-q-vane-inference-voices.md`](../external-research/20260714-042545_quin-q-vane-inference-voices.md) |
