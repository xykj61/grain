...
| **Pool** | Proposed (`20260714.040518`) — applications **P-vane**, Glow's Gall-role host, headlined as a **content-creation computational data market** (content · data · compute · demand pooled and exchanged); zero collision in the Urbit kernel; composes MALA · Neth · Granary · Mandi · Open Asks · Comlink · Sigma · Kumara; Linengrow and the market surfaces run *as agents in* Pool — [`../external-research/20260714-035600_pool-p-vane-content-data-market.md`](../external-research/20260714-035600_pool-p-vane-content-data-market.md) |
