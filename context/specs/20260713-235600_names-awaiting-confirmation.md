...
| **Quin (OS variant)** | fifth OS variant beside Reya - Riyo - Trey - Triz | **Confirmed** `20260717.162114` -- Keaton seated Quin as the fifth boot image. **Intentionally unpaired** `20260717.162620` -- no twin. Count later **accreted to six** with **Trya** `20260728.024417` (Quin still unpaired). Same name also carries the standing writing voice and the Q-vane -- three hats, accepted |
| **Trya (OS variant)** | sixth OS variant | **Confirmed** `20260728.024417` -- earth-craft nested voice - also Trya fund (Virgo 6). Identity [`../TRYA.md`](../TRYA.md) |
...
| **Nested deterministic testing / sandboxed ephemeral regions** | where agents spawn agents in test sandboxes | **Confirmed** `20260714.050500` -- the compose-don't-name recommendation is accepted as final: the sandbox loop is **Quin (agents) x Puddle (ephemeral isolation) x Neth (seeded deterministic replay)**, Maze-sheltered, TAME-guided. No new vane named for it |
| **Seva** | unified viewer -- Sala's successor name (*seva*, service) | **Confirmed** `20260724.200912` - landed `20260724.201334` - rename complete `20260724.202412` -- hand-seated; preference home. Claim [`../../waymarks/20260724-202412_seva-complete-mand-seated.md`](../../waymarks/20260724-202412_seva-complete-mand-seated.md) |
| **Seva** | unified viewer -- Sala's successor name (*seva*, service) | **Confirmed** `20260724.200912` - landed `20260724.201334` - rename complete `20260724.202412` -- hand-seated; preference home. Claim [`../../waymarks/20260724-202412_seva-complete-mand-seated.md`](../../waymarks/20260724-202412_seva-complete-mand-seated.md) |
| **Mand** | authority - scope - audit - retention (**M** kernel slot) | **Confirmed** `20260724.202412` -- in flw word list; exclude-seated. Prior same-day name Mona retired. Claim [`../../waymarks/20260724-202412_seva-complete-mand-seated.md`](../../waymarks/20260724-202412_seva-complete-mand-seated.md) |
| **Mona** | prior name of Mand (same day) | **Retired** `20260724.202412` -- exclude one season; dated counsel keeps Mona under erratum |

## Awaiting Confirm or Deny

Every name proposed so far -- Glow, Glow OS, Neth, Reya, Maze, Rish/Rishi, the module-vs-vane strategy, Ojjo (+ build timing), Riyo/Trey/Triz (+ the two-pair symmetry + redundancy shape), Pool (+ framing + timing), Rhyz (+ tier words + timing), Quin as Q-vane (+ the sandbox-loop composition), Quin as fifth OS variant, Seva (Realidream's revival-name), **Seva**, **Mand** (Mona prior) -- is now settled. See the Settled table above.

**Nothing remains open on this page as of `20260724.202412`.** Quin the OS variant is intentionally unpaired; five boot images is the settled count. A future proposal adds its own row here when it arises; this page stays the one return point for "what have we named but not yet settled."
