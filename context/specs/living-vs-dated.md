...
- **Amendable-roof dated paths** (`counsel/` · `active-designing/` · `expanding-prompts/` · `session-logs/` · `foundations/` · `waymarks/` · `active-reviving/` · `external-research/` · `edu/` · `press/` · `saga/` · `classical-vedic-astrology/` · `work-in-progress/` · `rye-learning-process/` · dated `context/specs/`) — OK; amendable until superseded.
