...
**Thin shape today:** test child `(gth tick 32)` only; body a decimal. Desks `glow/gen/a/assert-true.glow` - `assert-false.glow`. Witness: `tools/g/glow_lower_assert_witness.rish`.
...
**STOA91** seats the compact glyph alphabet and family index below (G2). Glow adopts Hoon's one-syllable glyph alphabet so digraphs stay speakable. Primary compile path is Glow->Rye->Zig->**RISC-V**; Nock is a second backend at a seam. Most `glow/gen/` files are **fixture desks** (baked sample). **G3** seats one thin parameterized **generator**: `glow/gen/s/sample-u32.glow` reads one `@u32` from Rishi argv. **G4** closes the lexer->lower mold seam: cross-desk parts - same-desk mold-body - shape-only peek - TAME tidy `lower_shape` - token->`ShapeSpec` in `rune_shape.parse_source` (STOA93-97 - API rename STOA189). **STOA100-101** seat thin `|=` bartis identity (baked 5) and argv generator `gate-sample-u32.glow`. **STOA102** seats `|^` **barket** horizon wording -- wet-gate digraph stays untokenized. Canon: [`../active-designing/date/20260719/20260719-204001_glow-rune-pronunciation-alphabet-riscv-and-generators.md`](../active-designing/date/20260719/20260719-204001_glow-rune-pronunciation-alphabet-riscv-and-generators.md) - G3 plan [`../active-designing/20260720-022956_stoa92-thin-argv-sample-g3-plan.md`](../active-designing/yonder/date/20260720/20260720-022956_stoa92-thin-argv-sample-g3-plan.md) - G4 plans [`../active-designing/20260720-023513_stoa93-token-driven-lower-slice-g4-plan.md`](../active-designing/yonder/date/20260720/20260720-023513_stoa93-token-driven-lower-slice-g4-plan.md) - [`../active-designing/20260720-024223_stoa94-same-desk-mold-body-tokens-g4-plan.md`](../active-designing/yonder/date/20260720/20260720-024223_stoa94-same-desk-mold-body-tokens-g4-plan.md). **G1 closed table**: [`../active-designing/date/20260719/20260719-220814_glow-rune-pronunciation-closed-table.md`](../active-designing/date/20260719/20260719-220814_glow-rune-pronunciation-closed-table.md).
...
G5 brief: [`../active-designing/20260720-033200_stoa98-g5-nock-second-backend-family-notes.md`](../active-designing/yonder/date/20260720/20260720-033200_stoa98-g5-nock-second-backend-family-notes.md). Witness: `tools/g/glow_g5_nock_family_notes_witness.rish`.
...
`|=` spoken **bartis** is the Hoon/Glow **stated** one-arm core with a typed **sample**. Language docs say **Glow gate** or **bartis gate** -- never bare itinerary **Gate** ([`LEXICON.md`](LEXICON.md)). **STOA100-101** seat identity + argv. **STOA103-104** deepen the body to closed one-arg calls: `double` - `inc` - `dec`. **STOA105** TAME-tidies `rune_shop_gate` / `lower_shop_gate`. `|^` spoken **barket** was named at horizon (**STOA102**), **tokenizes** as of **STOA111** (27th digraph), **parses** stated header/identity as of **STOA112**, **lowers** identity to `barket_gate` as of **STOA113**, seats **argv sample** as of **STOA114**, seats call-body **`%-  double`** as of **STOA115**, widens the closed call-body trio to **`inc` / `dec`** as of **STOA116**, **TAME-tidies** `rune_shop_nest` / `lower_shop_nest` as of **STOA117**, and seats named-mold **`amount-mold`** as of **STOA118**. **STOA106-110** seat nest/type through nesting refuse (`assert_sample_not_nesting`); **STOA119** seats mold-bounded nesting accept (`assert_sample_nesting_nests` for `@u32` and `amount-mold`); **STOA120** wires that API into barket/bartis expansion; **STOA121** seats barket as nesting through `assert_sample_nesting_nests(true, ...)` under stated molds; **STOA122** widens the closed named-mold allowlist with `count-mold` beside `amount-mold`; **STOA123** seats unit `$%` `kind-mold` gate samples as `KindMold` identity; **STOA124** seats payload `$%` `xact-mold` gate samples as `XactMold` identity; **STOA125** seats multi-face payload `$%` `xfer-mold` gate samples as `XferMold` identity; **STOA126** seats multi-field `$:` `pair-mold` gate samples as `PairMold` identity. Ambient gold still held; bartis stays stated.
...
| **STOA164 GREEN** | first unit `$%` dual `shape-kind` / cast twins; mold-kind kept |
...
| **STOA172 GREEN** | eight-field `$:` dual `shape-octa` -> `OctaShape`; mold-octa kept; cast held |
| **STOA173 GREEN** | nine-field `$:` dual `shape-nona` -> `NonaShape`; inventary duals closed at capacity freeze |
| **STOA174 GREEN** | living pin polish -- LEXICON - STOA - glow README lead with `shape-*`; mold twins study |
| **STOA175 GREEN** | multi-field `$:` named-cast emit - pair-shape cast twins; one-field kept |
| **STOA176 GREEN** | named-cast peek 4-12 - early glow_run path - triple...nona cast twins |
| **STOA179 GREEN** | seva-event-shape FactFields names - stand-in @u32 - Seva B0 Glow ladder |
| **STOA180 GREEN** | thin `@t` cord aura - bound 256 - parse - lower held - shape kept |
| **STOA181 GREEN** | `@t` cord lower -> `[256]u8` - seva-event text faces `@t` |
| **STOA182 GREEN** | named-cast `@t` emit - lean A - MemoShape `^-` |
| **STOA183 GREEN** | thin `@ux` hex - bound 32 - parse - lower held |
| **STOA184 GREEN** | `@ux` hex lower -> `[32]u8` - seva from/to `@ux` |
| **STOA185 GREEN** | Glow Seva B0 claim shell - elder `run_demo_fold` |
| **STOA186 GREEN** | seva-event cast twin - mixed `@ux`/`@u32`/`@t` |
...
| Still held | Seva B0 in Glow -- framework / product chapter |

G1 row brief (STOA100): [`../active-designing/date/20260720/20260720-033852_glow-bartis-g1-row.md`](../active-designing/date/20260720/20260720-033852_glow-bartis-g1-row.md). Argv brief (STOA101): [`../active-designing/date/20260720/20260720-040200_glow-bartis-argv-sample.md`](../active-designing/date/20260720/20260720-040200_glow-bartis-argv-sample.md). Barket horizon (STOA102): [`../active-designing/date/20260720/20260720-040700_stoa102-barket-horizon-wording.md`](../active-designing/date/20260720/20260720-040700_stoa102-barket-horizon-wording.md). Barket G1 tokenize (STOA111): [`../active-designing/date/20260720/20260720-151119_glow-barket-g1-row.md`](../active-designing/date/20260720/20260720-151119_glow-barket-g1-row.md) - [`../active-designing/date/20260720/20260720-151119_stoa111-barket-tokenize.md`](../active-designing/date/20260720/20260720-151119_stoa111-barket-tokenize.md). Barket parse (STOA112): [`../active-designing/date/20260720/20260720-174115_stoa112-barket-parse.md`](../active-designing/date/20260720/20260720-174115_stoa112-barket-parse.md). Barket lower (STOA113): [`../active-designing/date/20260720/20260720-175115_stoa113-barket-lower.md`](../active-designing/date/20260720/20260720-175115_stoa113-barket-lower.md). Barket argv (STOA114): [`../active-designing/date/20260720/20260720-175643_stoa114-barket-argv.md`](../active-designing/date/20260720/20260720-175643_stoa114-barket-argv.md). Barket call-body (STOA115): [`../active-designing/date/20260720/20260720-180047_stoa115-barket-call-body.md`](../active-designing/date/20260720/20260720-180047_stoa115-barket-call-body.md). Barket call-body inc/dec (STOA116): [`../active-designing/date/20260720/20260720-180445_stoa116-barket-call-body-inc-dec.md`](../active-designing/date/20260720/20260720-180445_stoa116-barket-call-body-inc-dec.md). Barket TAME tidy (STOA117): [`../active-designing/date/20260720/20260720-180900_stoa117-barket-tame-tidy.md`](../active-designing/date/20260720/20260720-180900_stoa117-barket-tame-tidy.md). Named-mold barket (STOA118): [`../active-designing/date/20260720/20260720-181347_stoa118-named-mold-barket.md`](../active-designing/date/20260720/20260720-181347_stoa118-named-mold-barket.md). Call body (STOA103): [`../active-designing/date/20260720/20260720-040800_glow-bartis-call-body.md`](../active-designing/date/20260720/20260720-040800_glow-bartis-call-body.md). Inc/dec (STOA104): [`../active-designing/20260720-041800_glow-bartis-call-body-inc-dec.md`](../active-designing/yonder/date/20260720/20260720-041800_glow-bartis-call-body-inc-dec.md). Tidy (STOA105): [`../active-designing/date/20260720/20260720-042300_glow-bartis-tame-tidy.md`](../active-designing/date/20260720/20260720-042300_glow-bartis-tame-tidy.md). Nest/type wording (STOA106): [`../active-designing/date/20260720/20260720-042931_stoa106-nest-type-surface-wording.md`](../active-designing/date/20260720/20260720-042931_stoa106-nest-type-surface-wording.md). Nest/type thin implement (STOA107): [`../active-designing/date/20260720/20260720-043251_stoa107-nest-type-thin-implement.md`](../active-designing/date/20260720/20260720-043251_stoa107-nest-type-thin-implement.md). Nest/type tag nest (STOA108): [`../active-designing/date/20260720/20260720-145814_stoa108-nest-type-tag-nest.md`](../active-designing/date/20260720/20260720-145814_stoa108-nest-type-tag-nest.md). Named-mold bartis (STOA109): [`../active-designing/date/20260720/20260720-150155_stoa109-named-mold-bartis.md`](../active-designing/date/20260720/20260720-150155_stoa109-named-mold-bartis.md). Wet-refuse nest (STOA110): [`../active-designing/date/20260720/20260720-150635_stoa110-wet-refuse-nest.md`](../active-designing/date/20260720/20260720-150635_stoa110-wet-refuse-nest.md). Wet-nests accept (STOA119): [`../active-designing/date/20260720/20260720-181950_stoa119-wet-accept-under-stated-mold.md`](../active-designing/date/20260720/20260720-181950_stoa119-wet-accept-under-stated-mold.md). Wet-nests barket wire (STOA120): [`../active-designing/date/20260720/20260720-182450_stoa120-wet-nests-barket-wire.md`](../active-designing/date/20260720/20260720-182450_stoa120-wet-nests-barket-wire.md). Barket wet-through-nests (STOA121): [`../active-designing/date/20260720/20260720-182915_stoa121-barket-wet-through-nests.md`](../active-designing/date/20260720/20260720-182915_stoa121-barket-wet-through-nests.md). Count-mold named (STOA122): [`../active-designing/date/20260720/20260720-183259_stoa122-count-mold-named.md`](../active-designing/date/20260720/20260720-183259_stoa122-count-mold-named.md). Kind-mold gate (STOA123): [`../active-designing/date/20260720/20260720-183837_stoa123-kind-mold-gate.md`](../active-designing/date/20260720/20260720-183837_stoa123-kind-mold-gate.md). Xact-mold gate (STOA124): [`../active-designing/date/20260720/20260720-184304_stoa124-xact-mold-gate.md`](../active-designing/date/20260720/20260720-184304_stoa124-xact-mold-gate.md). Xfer-mold gate (STOA125): [`../active-designing/date/20260720/20260720-184953_stoa125-xfer-mold-gate.md`](../active-designing/date/20260720/20260720-184953_stoa125-xfer-mold-gate.md). Pair-mold gate (STOA126): [`../active-designing/date/20260720/20260720-185502_stoa126-pair-mold-gate.md`](../active-designing/date/20260720/20260720-185502_stoa126-pair-mold-gate.md). Kind-mold flip call-body (STOA127): [`../active-designing/20260720-190544_stoa127-kind-call-body.md`](../active-designing/yonder/date/20260720/20260720-190544_stoa127-kind-call-body.md). Xact-mold flip call-body (STOA128): [`../active-designing/20260720-191033_stoa128-xact-call-body.md`](../active-designing/yonder/date/20260720/20260720-191033_stoa128-xact-call-body.md). Xfer-mold flip call-body (STOA129): [`../active-designing/20260720-192038_stoa129-xfer-call-body.md`](../active-designing/yonder/date/20260720/20260720-192038_stoa129-xfer-call-body.md). Stated/nesting/gold vocabulary (STOA130): [`../active-designing/date/20260720/20260720-192738_stoa130-stated-nesting-gold.md`](../active-designing/date/20260720/20260720-192738_stoa130-stated-nesting-gold.md). Pair-mold flip call-body (STOA131): [`../active-designing/yonder/date/20260720/20260720-193357_stoa131-pair-call-body.md`](../active-designing/yonder/date/20260720/20260720-193357_stoa131-pair-call-body.md). Amount-mold argv (STOA132): [`../active-designing/20260720-193805_stoa132-amount-argv.md`](../active-designing/yonder/date/20260720/20260720-193805_stoa132-amount-argv.md). Count-mold argv (STOA133): [`../active-designing/20260720-194143_stoa133-count-argv.md`](../active-designing/yonder/date/20260720/20260720-194143_stoa133-count-argv.md). Triple-mold gate (STOA134): [`../active-designing/date/20260720/20260720-194437_stoa134-triple-mold-gate.md`](../active-designing/date/20260720/20260720-194437_stoa134-triple-mold-gate.md). Quad-mold gate (STOA135): [`../active-designing/date/20260720/20260720-195131_stoa135-quad-mold-gate.md`](../active-designing/date/20260720/20260720-195131_stoa135-quad-mold-gate.md). Triple-mold flip call-body (STOA136): [`../active-designing/20260720-195742_stoa136-triple-flip.md`](../active-designing/yonder/date/20260720/20260720-195742_stoa136-triple-flip.md). Quad-mold flip call-body (STOA137): [`../active-designing/date/20260720/20260720-200022_stoa137-quad-flip.md`](../active-designing/date/20260720/20260720-200022_stoa137-quad-flip.md). Penta-mold gate (STOA138): [`../active-designing/date/20260720/20260720-200416_stoa138-penta-mold-gate.md`](../active-designing/date/20260720/20260720-200416_stoa138-penta-mold-gate.md). Penta-mold flip call-body (STOA139): [`../active-designing/date/20260720/20260720-215636_stoa139-penta-flip.md`](../active-designing/date/20260720/20260720-215636_stoa139-penta-flip.md). Hexa-mold gate (STOA140): [`../active-designing/date/20260720/20260720-221703_stoa140-hexa-mold-gate.md`](../active-designing/date/20260720/20260720-221703_stoa140-hexa-mold-gate.md). Hexa-mold flip call-body (STOA141): [`../active-designing/date/20260720/20260720-222406_stoa141-hexa-flip.md`](../active-designing/date/20260720/20260720-222406_stoa141-hexa-flip.md). Hepta-mold gate (STOA142): [`../active-designing/date/20260720/20260720-222827_stoa142-hepta-mold-gate.md`](../active-designing/date/20260720/20260720-222827_stoa142-hepta-mold-gate.md). Hepta-mold flip call-body (STOA143): [`../active-designing/date/20260720/20260720-224200_stoa143-hepta-flip.md`](../active-designing/date/20260720/20260720-224200_stoa143-hepta-flip.md). Octa-mold gate (STOA144): [`../active-designing/date/20260720/20260720-224907_stoa144-octa-mold-gate.md`](../active-designing/date/20260720/20260720-224907_stoa144-octa-mold-gate.md). Octa-mold flip call-body (STOA145): [`../active-designing/date/20260720/20260720-225659_stoa145-octa-flip.md`](../active-designing/date/20260720/20260720-225659_stoa145-octa-flip.md). Nona-mold gate (STOA146): [`../active-designing/yonder/date/20260720/20260720-230350_stoa146-nona-mold-gate.md`](../active-designing/yonder/date/20260720/20260720-230350_stoa146-nona-mold-gate.md). Nona-mold flip call-body (STOA147): [`../active-designing/20260720-231128_stoa147-nona-flip.md`](../active-designing/yonder/date/20260720/20260720-231128_stoa147-nona-flip.md). Capacity freeze (nine faces): [`../active-designing/date/20260720/20260720-231857_closed-field-capacity-freeze-and-framework-next.md`](../active-designing/date/20260720/20260720-231857_closed-field-capacity-freeze-and-framework-next.md). Amount-shape alias (STOA148): [`../active-designing/date/20260720/20260720-234340_stoa148-amount-shape-alias.md`](../active-designing/date/20260720/20260720-234340_stoa148-amount-shape-alias.md). Shape-amount dual (STOA161): [`../active-designing/date/20260721/20260721-010211_stoa161-shape-amount-dual-desk.md`](../active-designing/date/20260721/20260721-010211_stoa161-shape-amount-dual-desk.md). Shape-count dual (STOA162): [`../active-designing/20260721-010435_stoa162-shape-count-dual-desk.md`](../active-designing/yonder/date/20260721/20260721-010435_stoa162-shape-count-dual-desk.md). Shape-pair dual (STOA163): [`../active-designing/date/20260721/20260721-010610_stoa163-shape-pair-dual-desk.md`](../active-designing/date/20260721/20260721-010610_stoa163-shape-pair-dual-desk.md). Shape-kind dual (STOA164): [`../active-designing/20260721-010739_stoa164-shape-kind-dual-desk.md`](../active-designing/yonder/date/20260721/20260721-010739_stoa164-shape-kind-dual-desk.md). Shape-xact dual (STOA165): [`../active-designing/20260721-010935_stoa165-shape-xact-dual-desk.md`](../active-designing/yonder/date/20260721/20260721-010935_stoa165-shape-xact-dual-desk.md). Shape-xfer dual (STOA166): [`../active-designing/20260721-011110_stoa166-shape-xfer-dual-desk.md`](../active-designing/yonder/date/20260721/20260721-011110_stoa166-shape-xfer-dual-desk.md). Shape-triple dual (STOA167): [`../active-designing/20260721-011244_stoa167-shape-triple-dual-desk.md`](../active-designing/yonder/date/20260721/20260721-011244_stoa167-shape-triple-dual-desk.md). Shape-quad dual (STOA168): [`../active-designing/date/20260721/20260721-011412_stoa168-shape-quad-dual-desk.md`](../active-designing/date/20260721/20260721-011412_stoa168-shape-quad-dual-desk.md). Shape-penta dual (STOA169): [`../active-designing/20260721-011729_stoa169-shape-penta-dual-desk.md`](../active-designing/yonder/date/20260721/20260721-011729_stoa169-shape-penta-dual-desk.md). Shape-hexa dual (STOA170): [`../active-designing/20260721-012029_stoa170-shape-hexa-dual-desk.md`](../active-designing/yonder/date/20260721/20260721-012029_stoa170-shape-hexa-dual-desk.md). Shape-hepta dual (STOA171): [`../active-designing/20260721-012229_stoa171-shape-hepta-dual-desk.md`](../active-designing/yonder/date/20260721/20260721-012229_stoa171-shape-hepta-dual-desk.md). Shape-octa dual (STOA172): [`../active-designing/20260721-012414_stoa172-shape-octa-dual-desk.md`](../active-designing/yonder/date/20260721/20260721-012414_stoa172-shape-octa-dual-desk.md). Shape-nona dual (STOA173): [`../active-designing/20260721-012555_stoa173-shape-nona-dual-desk.md`](../active-designing/yonder/date/20260721/20260721-012555_stoa173-shape-nona-dual-desk.md). After dual inventary check-in (STOA174): [`../active-designing/date/20260721/20260721-012555_stoa174-after-dual-inventary-checkin.md`](../active-designing/date/20260721/20260721-012555_stoa174-after-dual-inventary-checkin.md). Living pin polish (STOA174 lean A): [`../active-designing/date/20260721/20260721-013023_stoa174-living-pin-polish-shape-primary.md`](../active-designing/date/20260721/20260721-013023_stoa174-living-pin-polish-shape-primary.md). Pair-shape named-cast (STOA175): [`../active-designing/20260721-013225_stoa175-pair-shape-named-cast.md`](../active-designing/yonder/date/20260721/20260721-013225_stoa175-pair-shape-named-cast.md). Peek widen + triple...nona casts (STOA176): [`../active-designing/20260721-014114_stoa176-named-cast-peek-widen-triple-nona.md`](../active-designing/yonder/date/20260721/20260721-014114_stoa176-named-cast-peek-widen-triple-nona.md). Seva-event-shape (STOA179): `../active-designing/yonder/date/20260721/20260721-170403_stoa179-sala-event-shape-desk.md` (`../active-designing/yonder/date/20260721/20260721-170403_stoa179-sala-event-shape-desk.md` -- never landed in any commit). Thin `@t` cord (STOA180): [`../active-designing/date/20260721/20260721-171800_stoa180-at-cord-aura-thin.md`](../active-designing/date/20260721/20260721-171800_stoa180-at-cord-aura-thin.md). Witnesses: `tools/g/glow_shop_gate_argv_witness.rish` - `tools/g/glow_shop_nest_tokenize_witness.rish` - `tools/g/glow_shop_nest_parse_witness.rish` - `tools/g/glow_shop_nest_lower_witness.rish` - `tools/g/glow_lower_shop_gate_witness.rish` - `tools/g/glow_nest_type_surface_witness.rish` - `tools/g/glow_nest_type_witness.rish` - `tools/g/glow_rune_alphabet_witness.rish`.
...
across journey, equinox, and chapter boundaries with each crossing named in the
...
Machine half: `tools/d/dated_guard.rish` refuses Tier 1 outright; permits Tier 2 when a `Radiant pass <stamp>` line is present (or living ledger / freeze pointer). Broad style passes earn honesty from `tools/cl/claim_preserve_witness.rish`. Spec: [`specs/living-vs-dated.md`](specs/living-vs-dated.md).
...
POSIX interop at the process boundary is a seam, not the model -- see [`active-designing/20260629-203012_posix-a-seam-not-a-model.md`](../active-designing/yonder/date/20260629/20260629-203012_posix-a-seam-not-a-model.md).
...
**Compiler fork (F1-F5):** deferred **horizon** -- deliberated only from a mature whole. See [`active-designing/date/20260628/20260628-043542_thin-frontend-slc-direction.md`](../active-designing/date/20260628/20260628-043542_thin-frontend-slc-direction.md). Prior fork-plan notes remain in [`active-designing/yonder/date/20260621/20260621-070712_the-compiler-fork.md`](../active-designing/yonder/date/20260621/20260621-070712_the-compiler-fork.md) as research, rather than the active primary track.
...
- **No witness yet.** `tools/t/tame-check.rish` does not flag `std.debug.print(`; add that rule only if the need is proven, the way we defer AST-tier lints.
...
`@memcpy` sites migrate as their files are touched; `tools/t/tame_style_check.rish` prints
...
`tools/t/tame_style_check.rish` prints the remaining count every parity run. Seated at counsel
...
`Ed25519` sites migrate on touch. `tools/t/tame_style_check.rish` prints the remaining count
...
### Chapter memory -- never `ArenaAllocator` directly
