...
**Thin shape today:** test child `(gth tick 32)` only; body a decimal. Desks `glow/gen/assert-true.glow` - `assert-false.glow`. Witness: `tools/g/glow_lower_assert_witness.rish`.
