...
| **12** | `reduce_mean` into 1×1 · shape assert | parity **299** · `tools/l/lattice_lap13.rish` (`200203`) |
...
| **15** | `reduce_max` into 1×1 · shape assert | parity **311** · `tools/l/lattice_lap16.rish` (`211930`) |
| **16** | `reduce_min` into 1×1 · shape assert | parity **315** · `tools/l/lattice_lap17.rish` (`212715`) |
