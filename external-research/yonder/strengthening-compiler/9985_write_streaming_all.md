...
### Witness `rye/tests/write_streaming_all_test.rye`
...
| File | Audit | Status |
|------|-------|--------|
| `misc` | `writeStreamingAll` — Phase 4 `usize` seam policy applied | done |
| `rye/tests/write_streaming_all_test.rye` | witness program | done |
| `tools/parity.rish` | witness registered | done |
| `external-research/yonder/strengthening-compiler/9985_write_streaming_all.md` | pass record + audited surfaces | done |
...
- [x] `std..Io.File.writeStreamingAll` — [`misc`](../../../misc)
