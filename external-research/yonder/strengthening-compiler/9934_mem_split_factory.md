...
### Witness `rye/tests/mem_split_factory_test.rye`
...
| `external-research/yonder/strengthening-compiler/9934_mem_split_factory.md` | pass record + audited surfaces | done |
