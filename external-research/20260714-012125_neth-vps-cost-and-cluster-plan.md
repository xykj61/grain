...
|---|---|---|---|---|---|---|
| **Hetzner** | CX32 | 4 | 8 GB | 80 GB NVMe SSD | **~EUR8.49 (~$9-10)** | local NVMe |
...
```
6 x Hetzner CX32 (replicas)  ~= 6 x $9.50  = $57.00/mo
1 x Hetzner CX32 (star + planet pier)      = $9.50/mo
                                    Total  ~= $66.50/mo
```
...
```
2 x Hetzner CX32   ~= 2 x $9.50   = $19.00/mo
2 x Contabo VPS S  ~= 2 x $7.00   = $14.00/mo
2 x Vultr (8 GB tier, true NVMe) ~= 2 x $40  = $80.00/mo
1 x Hetzner CX32 (star + planet) = $9.50/mo
                                    Total  ~= $122.50/mo
```
