...
## Two Forms of the Same Instant

| Where | Shape | Example |
|-------|--------|---------|
| Filename | hyphens | `20260709-235921_one-clock-plainly.md` |
| Body stamp | dots | `**Stamp:** 20260709.235921` |

Same moment, two spellings. The filename keeps the filesystem calm; the body stamp matches Rye's versioning voice.
...
Session logs, external-research, active-designing, counsel, and expanding-prompts all keep reverse-chronological **README** tables. The filesystem stays chronological; the index carries meaning a bare filename never could. `tools/align_session_logs.rish` (and kin) keep the living table true after batches.

---

## Companions

- Canon: [`20260627-102012_one-clock-naming-law.md`](../context/specs/20260627-102012_one-clock-naming-law.md)
- Filing: [`ORGANIZING.md`](../ORGANIZING.md)
- Graduation plainly (kitchen twin sibling): [`20260709-231011_graduation-rule-plainly.md`](20260709-231011_graduation-rule-plainly.md)
- What parity is: [`20260709-194437_what-parity-is.md`](20260709-194437_what-parity-is.md)

---

*May the clock keep our order true. May every stamp point at one door. May newest work rise where the index looks for it.*
