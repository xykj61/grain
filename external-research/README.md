...
| `20260717.172832` | [Dexter, Dill, and Glow input on GrapheneOS](20260717-172832_dexter-dill-glow-grapheneos-input.md) | Dexter = Brushstroke/Sala input hand; fuse with NativeActivity glass; Dill stays unfilled (no nest, no rename); TAME via emitted Rye; silo in `active-reviving/` |
...
| `20260715.181500` | [Sala as a broadcast surface -- a live session is a fold over a signed, ordered log](20260715-181500_sala-broadcast-live-session-fold.md) | Asciinema x WebSockets x Twitch x Sala x Mycelium x Lattice x Pool: a livestream is Weave/Mantra carried in order by Comlink and folded by Sala; B0-B3 ladder, gated behind Pool P0 |
...
| `20260715.165500` | [Glow, Neth, and the Urbit fleet](20260715-165500_glow-neth-and-the-urbit-fleet.md) | Sponsorship hierarchy = Neth's graduated trust; Rhyz x Neth x Pool x Comlink compose a fleet; one honest divergence -- Urbit keeps sponsorship lightweight by design |
...
| `20260710.131956` | [Seen books and the living desktop -- long horizon](20260710-131956_seen-books-living-desktop-horizon.md) | Visionary: carriage - books - sight; Dimeroll + Visual Track + Rye OS |
| `20260710.125953` | [Dimeroll -- Kick/Digits clean-room](20260710-125953_dimeroll-kick-digits-clean-room.md) | Public-docs concepts -> our chart/journal/fold vocabulary; no code copy |
...
| `20260710.002422` | [Amber chapters -- said plainly](20260710-002422_cellar-seasons-plainly.md) | Custody as bounded interval; seal - scrub - restore; cellar sleeps between |
...
| `20260703-182612` | [Sameness is the macro](20260703-182612_sameness-is-the-macro.md) | Graham x Hickey study; siloed companion in [`foundations/`](../foundations/20260703-182612_sameness-is-the-macro.md) |
