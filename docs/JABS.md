# JABS — Seva broadcast live-session fold ladder

*Waymark for Seva as a broadcast surface: session-as-log → live carriage → audience + back-channel. Compresses the silo; never replaces it.*
