...
*A Rye-native, parity-checked cryptography library — thirty-five primitives and twenty compositions, each GREEN on metal.*
...
## Rung table — fifty-five files, dependency order
...
fifty-five per-file witnesses in the dependency order above, refusing whole —
