...
*A Rye-native, parity-checked cryptography library — thirty-eight primitives and twenty-two compositions, each GREEN on metal.*
...
## Rung table — sixty files, dependency order
...
sixty per-file witnesses in the dependency order above, refusing whole —
