...
*A Rye-native, parity-checked cryptography library — thirty-five primitives and nineteen compositions, each GREEN on metal.*
...
## Rung table — fifty-four files, dependency order
...
fifty-four per-file witnesses in the dependency order above, refusing whole —
