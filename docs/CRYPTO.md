...
*A Rye-native, parity-checked cryptography library — fifty primitives and twenty-four compositions, each GREEN on metal.*
...
## Rung table — seventy-five files, dependency order
...
seventy-five per-file witnesses in the dependency order above, refusing whole —
