...
*A Rye-native, parity-checked cryptography library — thirty-nine primitives and twenty-two compositions, each GREEN on metal.*
...
## Rung table — sixty-one files, dependency order
...
sixty-one per-file witnesses in the dependency order above, refusing whole —
