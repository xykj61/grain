...
| 9 | [`TASKS.md`](../crux/TASKS.md) · [`ROADMAP.md`](../crux/ROADMAP.md) | Now and season |
...
| Word | Job |
|------|-----|
| **Gate** | Precondition before a lap opens |
| **Itinerary** | Named stops this minute |
...
Full table: [`context/LEXICON.md`](../context/LEXICON.md) § Cursor loop.

## Tutorial and markup spine
...
*May every cold start begin with the rose, and every why stay whole on the shelf beneath.*
