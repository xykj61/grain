...
This folder holds the vision. The build grows the SLC way — smallest lovable complete first — and its laps rest on the same modules Rye OS is already growing. The **commerce steward demo** (nib **419**) closes the in-process livelihood loop: Mandi list → settle → Dimeroll receipt — hammock [`../active-designing/20260711-004652_commerce-citizen-steward-demo-hammock.md`](../active-designing/20260711-004652_commerce-citizen-steward-demo-hammock.md).
