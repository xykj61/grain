...
| **MALA M1** | **One issuer, one holder** — mint, send, balance-as-fold on one node; [`mala.rye`](murr.rye) · witness **198** | design [`../active-designing/date/20260702/20260702-031312_modules-aspects-and-mailable-money.md`](../active-designing/date/20260702/20260702-031312_modules-aspects-and-mailable-money.md) |
| **MALA M2** | **Mailable (hosted)** — mint under Comlink seal; receipt back; [`mala_delivery.rye`](murr_delivery.rye) · witness **199** | prompt [`../expanding-prompts/yonder/20260709-191634_mala-m2-mailable-comlink.md`](../expanding-prompts/yonder/20260709-191634_mala-m2-mailable-comlink.md) |
