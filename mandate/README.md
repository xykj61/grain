...
**Language:** EN
**Status:** Living — the vector store · lap 1 seated `20260810.031234` · lap 2 (**remove** — full CRUD) `20260810` · lap 3 (**profile-loaded dim**) `20260810` · lap 4 (**dim from a real Bron profile**) `20260810` · lap 5 (**approximate index**) `20260810`
**Voice:** Kyri
...
- An **approximate index** for scale — **landed lap 5 `20260810`** (SimHash LSH, `query_approx`); a multi-probe / larger-signature refinement for real scale is the remaining horizon. And **object-storage backing** so the store is serverless like its inspiration.
