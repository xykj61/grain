...
| Item | Why |
|------|-----|
| Named-cast / `$%` `@t` | not opened this lap |
| `@ux` hex peer for pubkeys | lean B from STOA180 check-in |
| Elder Rye fold retire | product root still held |
...
*May every cord name its bound, and may session faces speak in text again.*
