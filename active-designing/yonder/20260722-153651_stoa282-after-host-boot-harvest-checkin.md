...
STOA281: host `hawm0_boot_harvest_onpath_host` GREEN - `serial emulator-5554` - harvest stamp `20260722.153549` (+ serial fold).
...
*May the next field name a root the glass already holds.*
