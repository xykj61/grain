...
| Affirm | Meaning |
|--------|---------|
| Same journal | Sight band folds the weave-sale journal, not the fixture books journal |
| Shared fold | Tip **424** view and tip **425** sight share `run_granary_steward_fold` |
