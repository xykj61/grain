...
**DEXTER_SALA_APPEND_THIN.** Glow already owns live `append_event`. Dexter already owns typed submit (held line + JABS2 paint). The thin door is a device-free witness that feeds a typed memo through product append without touching HAWM1.
...
*May every typed line that earns a signature keep the pinned demo honest beside it.*
