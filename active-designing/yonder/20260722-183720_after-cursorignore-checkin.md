# After Cursorignore - Check-In

*An Acme Corporation employee reading this gets the fork after `.cursorignore` seated: archive and caches leave the editor index, git stays whole, and the next door is either rest, a careful yonder pass on old designing, or slower file birth going forward.*
...
Root `.cursorignore` - `.gitignore` allows the file - brief names archive/cache/vendor out of the Cursor index.
...
*May the living shelf stay light enough to think in.*
