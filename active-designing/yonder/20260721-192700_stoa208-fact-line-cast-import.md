...
rishi/bin/rishi run tools/glow_run.rish glow/gen/cast-import-fact-line.glow
```
...
Fixture Glow literals. Line product wire. C replay inventory. JABS3. (Cord bound 1024: STOA209.)
