...
**SHAPE_HEXA_DUAL.** Seat `shape-hexa` so the six-field Glow OS desk leads with `hexa-shape`. `mold-hexa` stays. Allowlist alias from STOA157 stays. Cast twins held. Mold-only budget from STOA168 holds. Capacity freeze held.
...
rishi/bin/rishi run tools/glow_run.rish glow/gen/mold-hexa.glow
```
