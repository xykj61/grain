...
**SHAPE_ONLY_LIVING.** Citizen samples and printouts say `-shape`. Thin study-alias pins prove `amount-mold` still nests and lowers. HAWM log-harvest (**1A**) and fleets stay held for the mobile season.
...
rishi/bin/rishi run tools/stoa257_shape_only_living_witness.rish
```
