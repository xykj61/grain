...
**SHAPE_PENTA_DUAL.** Seat `shape-penta` so the five-field Glow OS desk leads with `penta-shape`. `mold-penta` stays. Allowlist alias from STOA156 stays. Cast twins held. Mold-only budget from STOA168 holds. Capacity freeze held.
...
rishi/bin/rishi run tools/glow_run.rish glow/gen/mold-penta.glow
```
