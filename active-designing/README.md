...
| `20260718.185147` | [Desk Hearth Hold — season open](20260718-185147_desk-hearth-hold-season.md) | HOLD0–HOLD1 · HOLD-W closed on eyes; SETU6 opened after |
...
| `20260715.212500` | [Modules, aspects, and vanes — a revived design sitting for the Glow OS galaxy series](20260715-212500_modules-aspects-vanes-and-the-galaxy-series.md) | Revives the modules-and-aspects elder, adding the vane layer + runtime/enclosure strata + the galaxy small-PR framing · the runtime is more foundational but the SLC ships now on the runtime pieces already green · runtime-unification named as a held proposal (Tilo/Toma clean; Tusk/Toon collide) |
| `20260715.194500` | [The SLC product — Glow on capable hardware, Sala broadcast as the flagship lap](20260715-194500_the-slc-product-glow-on-capable-hardware.md) | Glow software on capable hardware, not a fabricated phone · Sala broadcast the flagship, L1 green today · **go-to-market `200000`:** flagship-first (Pixel 10 Pro XL, GrapheneOS, most lovable for wealthy early adopters) then scale to value/pro/flagship tiers; the budget used-Pixel analysis is repositioned as the value tier, arriving last |
