...
| Stamp | Brief | Meaning |
|-------|-------|---------|
| `20260718.201232` | [SETU6 — device-wire lab harness](20260718-201232_setu6-device-wire-lab.md) | Lab card · stand-in/armed; live TX = SETU6.5 |
...
| `20260715.212500` | [Modules, aspects, and vanes — a revived design sitting for the Grain galaxy series](20260715-212500_modules-aspects-vanes-and-the-galaxy-series.md) | Revives the modules-and-aspects elder, adding the vane layer + runtime/enclosure strata + the galaxy small-PR framing · the runtime is more foundational but the SLC ships now on the runtime pieces already green · runtime-unification named as a held proposal (Tilo/Toma clean; Tusk/Toon collide) |
