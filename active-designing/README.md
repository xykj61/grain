...
| `20260715.194500` | [The SLC product — Glow on capable hardware, Sala broadcast as the flagship lap](20260715-194500_the-slc-product-glow-on-capable-hardware.md) | mikroPhone's performance limit points the SLC product to Glow software on capable hardware, not a fabricated phone · Sala broadcast the flagship, L1 green today, L2–L3 gated on Pool P0 · **reach tier `195500`:** used Pixel 7a/8a (de-Googled, ~$150–250) widens who can broadcast ~4x while the audience stays web-reachable |
