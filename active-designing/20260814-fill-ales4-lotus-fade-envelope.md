...
**Stamp:** `20260814.113625` · **Language:** EN · **Voice:** Kyri · **Style:** Radiant
...
2. **Saturation, still.** A ramp that climbs past `1×` pins each result to the i16 range rather than wrapping — the same floor and ceiling ALES2's gain keeps, **reused** from `timeline.saturate`. One true saturation across gain, mix, and now fade.
