# STOA341 — Face-Valued Arms (counsel V1)
...
Literal arms remain; strangers still `BodyFaceMismatch`.

## Prove

```
rishi/bin/rishi run tools/glow_bartis_pair_select_witness.rish
```

---

*May every wall answer with what it holds. May the next unary at the %- door be a vane's own name.*
