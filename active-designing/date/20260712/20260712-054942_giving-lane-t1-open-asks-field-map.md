...
2. **Two honest shapes — do not confuse.** *Quiet by courtesy* — consent-gated withholding on the glass (OA-L4 / `withheld=excluded`); fold still tells; small and shippable. *Private by proof* — tier mudra / buds on the fold; real log privacy; crosses MUR plaintext conservation (`fold_murr_log` (was fold_mala_log); was MALA; symbol held for module wave); wants its own brief before wire. Claude’s lean: courtesy as T2, proof as T3 in the ZK season (warm names still **proposed** — [`../context/specs/20260712-061012_bud-and-mudra-names-seated.md`](../context/specs/20260712-061012_bud-and-mudra-names-seated.md)).
