...
if grep -q '^### 93\.' "$ALMANAC"; then
  echo "almanac seat 93 already present"
  exit 0
fi
...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/gen/season/equinox_ironbeetle_ep038_choir_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/gen/season/ironbeetle_ep038_census_witness.rish` · scan `tools/fixtures/ironbeetle_ep038_census.sh` · choir `equinox_ironbeetle_ep038_choir_witness.rish`\n"
