...
case "$STEM" in
sample-u32|gate-sample-u32|gate-double-u32|gate-pleac-double-u32|gate-surface-double-u32|gate-surface-inc-u32|gate-tally-dec-u32|gate-tally-garden-bound-u32|gate-caravan-dependents-bound-u32|gate-aurora-wire-bound-u32|gate-say-u32|gate-inc-u32|gate-dec-u32|gate-amount-u32|gate-count-u32|gate-barket-sample-u32|gate-barket-double-u32|gate-barket-inc-u32|gate-barket-dec-u32|gate-barket-amount-u32|gate-barket-count-u32)
  test "$NARGS" -eq 1 || {
