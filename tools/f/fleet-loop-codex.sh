...
# Fleet default selected by Keaton on 20260923. The API model id is gpt-6-luna
# (developers.openai.com/api/docs/models/gpt-6-luna). User config sets the same
# id in ~/.codex/config.toml as model. Explicit CODEX_MODEL overrides remain supported.
