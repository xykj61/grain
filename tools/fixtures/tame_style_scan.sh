...
#
# Scan roster: mantra caravan linengrow comlink rishi/src tally aurora pond brushstroke image rye/src
# plus Glow TAME surfaces: tokens · lower_named_cast (STOA86–87) on the 256 roster;
# lower_shape (STOA96) · lower_bartis (STOA105) · lower_barket (STOA117) ride one-file ban overflow seats + width-check.
