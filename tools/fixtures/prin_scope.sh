...
Prin scope — seasons · Tally · rish vocabulary
  ...
  innermost: MUR Season — OPEN · u49 complete / u50 next (module entry/bin LIVE · rename overwrite)
  ...
  seat:   counsel/20260728-054644_mur-season-u49-module-entry-bin-live.md
