#!/bin/sh
# gen_keeh_fund_prep.sh — Keeh fund prep (Aquarius · was Ketu)
set -eu
...
echo "season: Keeh Season quint q0-q15 lean · expand 32 · fascia edit rename"
echo "page: edu/funds/keeh-opening.md"
echo "witness:keeh-open GREEN — seat · executive · hard lines · rename spine"
echo "refuse: deploy · wallet · gas · shred · breach"
echo "keeh_fund=prep"
echo "GREEN: gen-keeh — Aquarius seat 11 prep · Keeh rename · deploy RED"
