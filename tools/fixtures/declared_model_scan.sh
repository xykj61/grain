#!/bin/sh
# tools/fixtures/declared_model_scan.sh -- every site that states the model agrees with the driver.
#
# WHY. See tools/fixtures/declared_model.sh. Four sites named the model on 20260824 and two of them
...
#
# USAGE
#   sh tools/fixtures/declared_model_scan.sh
#
...
read_one="$root/tools/fixtures/declared_model.sh"
...
while IFS= read -r f; do
  ...
  # `claude-[a-z0-9-]*` and returned 71 files -- claude-code, .claude-state, launch-claude-season.
