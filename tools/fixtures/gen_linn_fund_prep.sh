#!/bin/sh
# gen_linn_fund_prep.sh — Linn fund prep (Capricorn earth · seat 10)
set -eu
...
echo "hats: dedication·sponsor·executive held (blank)"
echo "page: edu/funds/linn-opening.md (prep grow · page one)"
echo "witness:linn-open GREEN — seat · vane · hard lines"
echo "refuse: deploy · wallet · gas · claim-domain · shred · breach"
echo "linn_fund=prep"
echo "GREEN: gen-linn — Capricorn earth seat 10 prep open · deploy RED"
