...
#
#   sh tools/fixtures/equinox_e137_cellar_unify_scan.sh
#   sh tools/fixtures/equinox_e137_cellar_unify_scan.sh prove-red
set -eu
...
echo "story=e137_dated>e138_accretion>cellar_kept>shred_held>128_reserved"
echo "verdict=ok"
