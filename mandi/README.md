...
**Status:** Seated — name + lap 1 listing (`165634`); floor view (`170700`); listing settle lap 3 (`171202`); settle view lap 4 (`172955`); **steward demo** list→settle→Dimeroll (`004652`, nib **419**); live TigerBeetle rests until its brief
